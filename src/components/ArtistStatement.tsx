        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed font-light">
              Daniel Urbina, known professionally as Dankoshi, is a contemporary artist whose work 
            ...
            <p className="text-lg text-gray-700 mb-12 leading-relaxed font-light">
              ...
              was established in 2023 as a way to share these visual journeys with a wider audience.
            </p>
